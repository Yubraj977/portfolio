...
function Home() {
  return (
    <div className="main   flex flex-col lg:h-screen   md:h-screen lg:flex-row lg: px-4 lg:pl-8    pt-16 lg:justify-between dark:bg-white bg-black " >
      ...
      {/* For the left part */}
      <div className= '  text-white flex-flex-col lg:w-1/3 lg:ml-[16rem] mt-10  lg:mt-40 h-fit justify-center items-center dark:text-first'>
